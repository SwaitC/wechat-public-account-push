export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe35a12e5b95d5fd4",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "709b359d0e6de7778459fa1531a18c64",
  ...
  USERS: [
    {
      ...
      id: "ot3Ij5xmpmeISpjxHTyxE9finw3M",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "lDlMRsrRC6C8gGw6PGPCs7N1Tjd1z9xy5Qcj57ETlCc",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "潍坊",
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2021-12-04"},
        // 宝宝生日
        {"keyword": "birthday_day", date: "12-16"}
    {
      name: "老婆1",
      id: "",
      useTemplateId: "",
